...
public class AggsTest {
    ...
    /**
     * @Description 需求一：按照颜色分组，计算每个颜色卖出的个数
     * @Auther pengl
     * @Date 2021/5/14 9:11
     **/
    @Test
    ...
    /**
     * @Description 需求二：按照颜色分组，计算每个颜色卖出的个数，每个颜色卖出的平均价格
     * @Auther pengl
     * @Date 2021/5/14 9:52
     **/
    @Test
    ...
    /**
     * @Description 需求三：按照颜色分组，计算每个颜色卖出的个数，以及每个颜色卖出的平均值、最大值、最小值、总和。
     * @Auther pengl
    ...
    /**
     * @Description 需求四：按照售价每2000价格划分范围，算出每个区间的销售总额 histogram
     * @Auther pengl
    ...
    public void testAggsAndDateHistogram() throws IOException {
        ...
        DateHistogramAggregationBuilder dateHistogramAggregationBuilder = AggregationBuilders.dateHistogram("date_histogram")
                .field("sold_date")
